...
<nav class="navbar navbar-expand-sm navbar-dark bg-custom navbar-custom">
	<div class="container-fluid">
		<a class="navbar-brand" href="javascript:void(0)">E-Text</a>
		...
		<div class="collapse navbar-collapse" id="mynavbar">
			<ul class="navbar-nav me-auto">
				...
				<li class="nav-item"><a class="nav-link"
					href="addnotes.jsp">Add Text </a></li>
				<li class="nav-item"><a class="nav-link"
					href="shownotes.jsp">Show Text</a></li>
			</ul>
			<%
				...
				<div id="id01" class="w3-modal w3-animate-opacity">
					<div class="w3-modal-content w3-card-4">
						...
						<footer class="w3-container w3-teal">
							...
							<button type="button" class="btn btn-primary" data-dismiss="model">Close</button>
							<button type="button" class="btn btn-primary" data-dismiss="model">Save</button>
